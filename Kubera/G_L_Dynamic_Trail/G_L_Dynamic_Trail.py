    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        for timeData in df.index: 
            ...
            if timeData in df_GL.index:
                ...
                self.strategyLogger.info(f"{self.humanTime} stock_list: {stock_list}")
                self.strategyLogger.info(f"{self.humanTime} top: {top} bottom: {bottom}")
