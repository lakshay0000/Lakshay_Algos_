    ...
    # Calculate the 200-period EMA
        ...
        for timeData in df.index: 
            ...
            if ((timeData-900) in df_15min.index) and stockAlgoLogic.openPnl.empty:
                ...
                if (CallEntryAllow): 
                    if (df_15min.at[last15MinIndexTimeData[1], "c"]> Twoswinghigh) and (df_15min.at[last15MinIndexTimeData[1], "c"]> df_15min.at[last15MinIndexTimeData[1], "EMA_High"]):
                        list1_high.append(df_15min.at[last15MinIndexTimeData[1], "h"])
                ...
                if (PutEntryAllow):
                    if df_15min.at[last15MinIndexTimeData[1], "c"]< Twoswinglow and (df_15min.at[last15MinIndexTimeData[1], "c"]< df_15min.at[last15MinIndexTimeData[1], "EMA_Low"]):
                        list1_low.append(df_15min.at[last15MinIndexTimeData[1], "l"])
                        logger.info(f"{self.humanTime}\t{self.timeData}\t{stockName}\tclose:{df_15min.at[last15MinIndexTimeData[1], 'c']}")
