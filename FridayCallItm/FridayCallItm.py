...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        flag1=0
        flag2=0
        expiryEpoch = self.getCurrentExpiryEpoch(startDate, baseSym)
        ...
        for timeData in df.index:
           ...
           #skip times period other than trading hours than ()
            ...
            if ((timeData-3600) in df_1h.index) and (self.humanTime.time() < time(14, 15)) and (flag1==1):
            ...
            elif ((timeData-3600) in df_1h.index) and (flag2==1):
                ...
                if  (df_1h.at[last1HIndexTimeData[1], "Scross"]==1):
                    if (self.humanTime.date()== expiry.date()):
                        ...
                        putSym = self.getPutSym(self.timeData+86400, baseSym, df.at[lastIndexTimeData[1], "c"],otmFactor=-2)
                    else:
