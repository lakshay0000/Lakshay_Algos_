...
class algoLogic(optOverNightAlgoLogic):
    ...
    def straddle(self, date, IndexPrice, baseSym):
        ...
        for i in Factor:
            ...
            if i != 0:
                i = -i  # Ensure otmFactor is positive for put options
            else:
                i = 0
        ...
        # self.strategyLogger.info(f"Straddle for {baseSym} on {date} is {minIndex}")
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        for timeData in df.index: 
            ...
            if self.humanTime.date() == datetime(2025, 4, 7).date():
                continue
            ...
            if not self.openPnl.empty:
                for index, row in self.openPnl.iterrows():
                    ...
                    elif Current_strangle_value >= 1.3 * strangle:
