                ...
                if df_CE is None:
                    try:
                        ...
                        if callSym not in stock_state:
                            ...
                            stock_state[callSym] = {"expiryEpoch": expiryEpoch}
                ...
                if df_PE is None:
                    try:
                        ...
                        if putSym not in stock_state:
                            ...
                            stock_state[putSym] = {"expiryEpoch": expiryEpoch}
                ...
                for symbol, df_opt in Symbol_1min_data.items():
                    ...
                    if symSide=='CE' and sym_count < 1 and callCounter < 3:
                        if df_opt.at[lastIndexTimeData[1], "HRSO"] < CE_Low and df_opt.at[lastIndexTimeData[1], "rsi"] < 30:
                            ...
                            expiry = state["expiryEpoch"]

                            self.entryOrder(entry_price, symbol, lotSize, "SELL", {"Expiry": expiry,"Target": target,"stoploss":stoploss, "Trailing_Target": Trailing_Target},)
