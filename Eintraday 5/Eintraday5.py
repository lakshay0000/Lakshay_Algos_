        ...
        for timeData in df.index:
            ...
            if last5MinIndexTimeData[1] in df_5min.index:
                if stockAlgoLogic.humanTime.time() == time(9, 45):
                    ...
                    breakf = df_5min.at[last5MinIndexTimeData[1], "l"]
                    tradef=1
            ...
            if (stockAlgoLogic.openPnl.empty) & (stockAlgoLogic.humanTime.time() > time(9, 45)) & (stockAlgoLogic.humanTime.time() < time(15, 15)):
                if (timeData-300) in df_5min.index:
                    if (df_5min.at[last5MinIndexTimeData[1], "c"] > breakp) & (tradef==1):
                    ...
                    if (df_5min.at[last5MinIndexTimeData[1], "c"] < breakf) & (tradef==1):
                        entry_price = df_5min.at[last5MinIndexTimeData[1], "c"]
