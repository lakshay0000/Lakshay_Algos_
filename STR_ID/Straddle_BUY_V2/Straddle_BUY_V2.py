    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        for timeData in df.index: 
            ...
            if ((timeData-60) in df.index):
                ...
                if self.humanTime.time() == time(9, 16) and self.humanTime.date() != expiryDatetime.date():
                    ...
                    otm = round((StraddlePremium*2)/50)
                    self.strategyLogger.info(f"Calculated OTM factor is {otm}")
