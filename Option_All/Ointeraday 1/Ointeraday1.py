...
class algoLogic(optIntraDayAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        try:
            ...
            df_5min = getFnoBacktestData(indexSym, startEpoch, endEpoch, "5Min")
        ...
        # Update lastIndexTimeData
            ...
            if last5MinIndexTimeData[1] in df.index:
            ...
            if ((timeData-300) in df_5min.index) & (self.humanTime.time() < time(15, 15)) : 
                if (df_5min.at[last5MinIndexTimeData[1], "c"] > df_5min.at[last5MinIndexTimeData[1], "ema15"]) & (f1 == 1):
                ...
                if (df_5min.at[last5MinIndexTimeData[1], "c"] < df_5min.at[last5MinIndexTimeData[1], "ema15"]) & (t1==1):
...
if __name__ == "__main__":
    ...
    endDate = datetime(2021, 5, 31, 15, 30)
