    ...
    def runBacktest(self, baseSym, startDate, endDate):
        ...
        for timeData in df.index:
            ...
            if ((timeData-60) in df.index):
                ...
                # for sensex
                    prmtb = self.OptChain(lastIndexTimeData[1], "CE", df.at[lastIndexTimeData[1], "c_from_SS"], "SENSEX")
                    ...
                    prmtb = self.OptChain(lastIndexTimeData[1], "PE", df.at[lastIndexTimeData[1], "c_from_SS"], "SENSEX")
                ...
                #     # for nifty
                #     prmtb = self.OptChain(self.timeData, "CE", df.at[lastIndexTimeData[1], "c"], "NIFTY")
                ...
                #     prmtb = self.OptChain(self.timeData, "PE", df.at[lastIndexTimeData[1], "c"], "NIFTY")
